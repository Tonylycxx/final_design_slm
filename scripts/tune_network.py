...
if __name__ == "__main__":
    ...
    parser.add_argument("--cost-model", type=str, choices=['xgb', 'lgbm', 'random', 'xgb-no-update', 'lgbm-no-update', 'mlp', 'mlp-no-update', 'tab', 'tab-no-update', 'tlp-no-update', 'slm-no-update'],
