...
from .cost_model import RandomModel, XGBModel, MLPModel, LGBModel, TabNetModel, SlmPModel
    ...
    if isinstance(search_policy, str):
        ...
        if model_type in ['xgb', 'xgb-no-update', 'mlp', 'mlp-no-update', 'tab', 'tab-no-update', 'slm-no-update']:
            ...
            if model_type in ['xgb', 'xgb-no-update']:
                ...
                cost_model = SlmPModel(target=tasks[0].target, max_line_len=max_line_len, max_vec_len=max_vec_len)
